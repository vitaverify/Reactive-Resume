...
const Home = () => (
  ...
  <Wrapper>
    <Helmet>
      <title>Vita Resume Builder</title>
    ...
    <div className="container px-8 xl:px-0 text-center md:text-left mt-24">
      ...
      <p className="leading-loose text-lg mt-16">
        A resume builder that’s built to make the mundane tasks of creating,
        updating and sharing your resume as easy as 1, 2, 3. With this app, you
        can create multiple resumes, share them with recruiters through a unique
        link and print as PDF, all for free, no advertisements, without losing
      ...
      <div className="pt-8 grid lg:grid-cols-2 lg:gap-x-10">
        ...
        >
          There are brilliant alternatives to this app like Novoresume and Zety
        ...
        >
          You must be thinking, if you&apos;re not paying for the product, then
          you are the product. Or, at least your data is?{' '}
