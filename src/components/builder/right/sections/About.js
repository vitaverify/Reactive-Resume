...
const About = ({ id }) => (
  ...
  <section>
    ...
    <div className={styles.container}>
      <h5>Like this builder?</h5>

      <p className="leading-loose">
        Come to our main site to learn more about what we offer
      </p>

      <div className="mt-4 flex">
        <a href="https://vitaverify.me" rel="noreferrer" target="_blank">
          <Button icon={FaExternalLinkAlt}>Vita Verify</Button>
        </a>
      </div>
    </div>
